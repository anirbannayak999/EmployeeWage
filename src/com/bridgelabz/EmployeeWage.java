...
public class EmployeeWage {
    ...
    static void calculateEmployeeWage(String companyName, int empRatePerHour, int numOfWorkingDays, int maxHoursInMonth) {
    ...
    public static void main(String[] args) {
        ...
        calculateEmployeeWage("flipkart", 60, 20, 100);
        calculateEmployeeWage("Netflix", 90, 18, 220);
        calculateEmployeeWage("facebook", 100, 20, 250);
